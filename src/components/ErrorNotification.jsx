...
const ErrorNotification = () => {
  ...
  return (
    <div className={`fixed left-0 right-0 z-50 transform transition-transform duration-300 ease-in-out ${isVisible ? 'translate-y-4' : '-translate-y-full'}`}>
        <div className="mx-auto max-w-[90%] sm:max-w-[200px] text-[14px] bg-[#fceded] text-[#5e2120] px-3 py-4 rounded-md shadow-lg text-center flex flex-row gap-2 justify-center">
