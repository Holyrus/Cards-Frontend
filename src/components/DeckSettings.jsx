  ...
  return (
    <div className="min-h-screen flex flex-col items-center w-full">
      ...
      <div className="w-full flex-none flex flex-row items-center justify-center border-b-1 border-[#e1edf5] h-[55px]">
        ...
        <h1 className="w-[260px] sm:w-[410px] text-center">Edit deck</h1>
        <div className="w-[40px]"></div>
      </div>

      <div className="flex-1 flex mb-[55px] py-[25px] flex-col items-center justify-start w-full bg-[#f3fff2]">
        ...
        <div className="flex flex-col items-center sm:items-start justify-start w-[320px] sm:w-[450px]">
          ...
          <button className="mt-3 w-[290px] sm:w-full rounded-full border-1 border-green-600 bg-[#f6f3f3] py-4 pl-7 pr-5 flex flex-row items-center justify-between cursor-default">
            ...
            <svg className="w-[24px] text-gray-400" fill="currentColor" focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="ExpandMoreIcon"><path d="M16.59 8.59 12 13.17 7.41 8.59 6 10l6 6 6-6z"></path></svg>
        ...
        <button onClick={changeDeckHandler} className={`mt-9 rounded-full text-white font-semibold py-2 px-5 w-[290px] sm:w-[450px] sm:py-3 shadow-md ${natLanguage === selectedDeck.natLang ? 'bg-[#cccccc]' : 'bg-green-700 hover:shadow-lg hover:bg-green-100 hover:text-green-700 border-1 border-green-700 transition-all duration-300'}`}>SAVE</button>
        
        <button onClick={deleteDeckHandler} className={`mt-4 rounded-full text-black font-semibold py-2 px-5 w-[290px] sm:w-[450px] sm:py-3 bg-transparent hover:bg-green-100 hover:text-green-700 transition-all duration-300`}>DELETE DECK</button>
