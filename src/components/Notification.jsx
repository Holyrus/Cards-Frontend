...
const Notification = () => {
  ...
  return (
    <div className={`fixed left-0 right-0 z-60 transform transition-transform duration-300 ease-in-out ${isVisible ? 'translate-y-4' : '-translate-y-full'}`}>
        <div className="mx-auto max-w-[90%] sm:max-w-[200px] text-[14px] bg-[#edf7ed] text-[#1e4520] px-3 py-4 rounded-md border-1 border-[#ebe9e8] text-center flex flex-row gap-2 justify-center">
