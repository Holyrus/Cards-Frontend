  ...
  return (
    <div className='min-h-screen flex flex-col items-center justify-between'>
          ...
          <div className='flex flex-col items-center'>
            <img src={Panda} alt="Panda" className='w-[230px]' />
          ...
          <form onSubmit={handleSubmit} className='flex flex-col mb-10 sm:mb-50'>
            ...
            <div className='relative flex mt-4'>
              ...
              <label htmlFor="signUpName" className= 'z-5 absolute left-2 text-gray-500 peer-placeholder-shown:bottom-5 peer-placeholder-shown:text-[16px] peer-placeholder-shown:text-gray-400 peer-focus:top-0 peer-focus:text-green-500 peer-focus:text-[12px] transition-all'>Name</label>
            </div>
            <div className='relative flex mt-4'>
              ...
              <label htmlFor="signUpPassword" className= 'z-5 absolute left-2 text-gray-500 peer-placeholder-shown:bottom-5 peer-placeholder-shown:text-[16px] peer-placeholder-shown:text-gray-400 peer-focus:top-0 peer-focus:text-green-500 peer-focus:text-[12px] transition-all'>Password</label>
            </div>
