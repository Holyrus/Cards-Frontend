    ...
    <div className='min-h-screen flex flex-col items-center justify-between'>
          ...
          <form onSubmit={handleSubmit} className='flex flex-col mb-10 sm:mb-50'>
            <div className='relative flex mt-4'>
              ...
              <label htmlFor="signUpUsername" className='z-5 absolute left-2 text-gray-500 text-[12px] peer-placeholder-shown:bottom-5 peer-placeholder-shown:text-[16px] peer-placeholder-shown:text-gray-400 peer-focus:top-0 peer-focus:text-green-500 peer-focus:text-[12px] transition-all'>Username</label>
            </div>
            <div className='relative flex mt-4'>
