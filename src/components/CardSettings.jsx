...
const CardSettings = ({ selectedCard, currentDeck }) => {
  ...
  return (
    ...
    <div className="w-full flex-none flex flex-row items-center bg-[#f3fff2] justify-center h-[55px]">
      <h1 className="w-[260px] sm:w-[410px] text-center"></h1>
      <div className="relative w-[40px] h-[30px]"></div>
      <Link to="/main">
        <svg className="w-[40px] rounded-full hover:bg-[#edeeee] p-2 text-[#6f7275]" fill="currentColor" focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="CloseIcon"><path d="M19 6.41 17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"></path></svg>
    ...
    <form onSubmit={changeCardHandler} className="flex-1 flex py-[45px] flex-col items-center justify-start w-full bg-[#f3fff2]">
      ...
      <div className='relative flex mt-4 w-[280px] sm:w-[500px] bg-white rounded-t-sm'>
        ...
        <button className="absolute z-10 right-1.5 top-1.5 p-1.5 bg-transparent hover:bg-[#f7f7f7] rounded-full">
