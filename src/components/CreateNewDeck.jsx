...
const CreateNewDeck = ({ createDeck }) => {
  ...
  return (
    <div className={`min-h-screen flex flex-col items-center w-full ${theme === 'Black' ? 'dark-scrollbar' : ''}`}>
      ...
      <div className={`flex-1 flex mb-[55px] py-[45px] flex-col items-center justify-start w-full
